"""Structured human feedback ledger: stage-level decisions with reason codes.

This is the review-console side of feedback (plan approved, files rejected, reason
codes). GitHub pull-request reviews are mirrored separately by `ase.feedback.reviews`,
and both feed the labelled dataset in `ase.feedback.dataset`.
"""
